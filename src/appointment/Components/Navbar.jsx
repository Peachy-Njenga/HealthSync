    ...
    <div className="flex h-20 justify-between p-2 items-center">
      ...
      <ul className="navbar-items">
        <li>
          <Link
            to="/"
            className="text-white hover:text-blue-500 hover:border-b-2 transition duration-300 hover:border-blue-500 p-2 "
          >
            Home
          </Link>
        </li>
      ...
      <div className="bg-blue-400 p-2 rounded w-24 text-white text-center">
        <LoginButton />
      </div>
